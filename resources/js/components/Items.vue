                ...
                <div class="p-modal">
                    ...
                    <div class="c-buttonWrap">
                        ...
                        <div class="p-item__modal--iconWrap u-mb__30">
                            ...
                            <a :href="`http://twitter.com/share?text=◾️${record.record_name}のきろく%0a%0a${checkText}%0a&url=https://chikichiki-tony.sakura.ne.jp/kotunote/everyone/${record.id}/items%0a%0a&hashtags=今日もこつこつ`" target="__blank" class="p-item__modal--icon -twitter">
