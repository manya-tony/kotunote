...
class Items1TableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-01-08 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'もうひとつのワンダー',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            'text' => '父親が子どもの未来を輝かせる',
            'record_id' => 4,
            'created_at' => '2018-02-05 00:00:00',
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-02-07 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '史上最強の哲学入門',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            'text' => '飲茶の最強のニーチェ',
            'record_id' => 4,
            'created_at' => '2018-03-05 00:00:00',
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-03-06 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '14歳からの哲学入門',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-03-08 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'ホモ・デウス上下',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-04-04 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '成功ではなく、幸福について語ろう',
            'record_id' => 4,
            'created_at' => '2018-04-05 00:00:00',
            'updated_at' => '2018-04-05 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '反応しない練習',
            'record_id' => 4,
            'created_at' => '2018-04-06 00:00:00',
            'updated_at' => '2018-04-06 00:00:00',
        ]);
        DB::table('items')->insert([
        ...
        DB::table('items')->insert([
            'text' => '働き方の哲学',
            'record_id' => 4,
            'created_at' => '2018-04-08 00:00:00',
            'updated_at' => '2018-04-08 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '14歳からの哲学',
            'record_id' => 4,
            'created_at' => '2018-04-09 00:00:00',
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-05-02 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '暇と退屈の倫理学',
            'record_id' => 4,
            'created_at' => '2018-05-03 00:00:00',
            'updated_at' => '2018-05-03 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'わけあって絶滅しました',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-05-06 00:00:00',
        ]);
        DB::table('items')->insert([
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-05-10 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'ゼロトゥワン',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-06-02 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '最前線の映画を読む',
            'record_id' => 4,
            'created_at' => '2018-06-03 00:00:00',
            'updated_at' => '2018-06-03 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '恐い間取り',
            'record_id' => 4,
            'created_at' => '2018-06-04 00:00:00',
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-06-05 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'ユーチューバーが消滅する未来',
            'record_id' => 4,
            'created_at' => '2018-06-06 00:00:00',
            'updated_at' => '2018-06-06 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'てつがくフレンズ(2回目)',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-06-08 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '反応しない練習(2回目)',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-08-02 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '自分の中に孤独を抱け',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2018-08-04 00:00:00',
        ]);
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-02-04 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '中動態の世界',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-03-05 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '健康の結論',
            'record_id' => 4,
            'created_at' => '2019-03-06 00:00:00',
            'updated_at' => '2019-03-06 00:00:00',
        ]);
        DB::table('items')->insert([
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-04-04 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'ハーディング家の子育て',
            'record_id' => 4,
            'created_at' => '2019-04-05 00:00:00',
            'updated_at' => '2019-04-05 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '小さな天才の育て方・育ち方',
            'record_id' => 4,
            'created_at' => '2019-04-06 00:00:00',
            'updated_at' => '2019-04-06 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '死に山',
            'record_id' => 4,
            'created_at' => '2019-04-07 00:00:00',
            'updated_at' => '2019-04-07 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'その問題、経済学で解決できます',
            'record_id' => 4,
            'created_at' => '2019-04-08 00:00:00',
            'updated_at' => '2019-04-08 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '触れることの科学',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-05-02 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'GAFA',
            'record_id' => 4,
            'created_at' => '2019-05-03 00:00:00',
            'updated_at' => '2019-05-03 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '超効率勉強法',
            'record_id' => 4,
            'created_at' => '2019-05-04 00:00:00',
            'updated_at' => '2019-05-04 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '進化する勉強法',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-07-04 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '0円で生きる',
            'record_id' => 4,
            'created_at' => '2019-07-05 00:00:00',
            'updated_at' => '2019-07-05 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '超人脈術',
            'record_id' => 4,
            'created_at' => '2019-07-06 00:00:00',
            'updated_at' => '2019-07-06 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '強いチームはオフィスを捨てる',
            'record_id' => 4,
            'created_at' => '2019-07-07 00:00:00',
            'updated_at' => '2019-07-07 00:00:00',
        ]);
        DB::table('items')->insert([
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-08-02 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '恥さらし',
            'record_id' => 4,
            'created_at' => '2019-08-03 00:00:00',
            'updated_at' => '2019-08-03 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '日本で一番悪い奴ら',
            'record_id' => 4,
            'created_at' => '2019-08-04 00:00:00',
            'updated_at' => '2019-08-04 00:00:00',
        ]);
        DB::table('items')->insert([
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-08-06 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'オリジナルズ 誰もが人と違うことができる時代',
            'record_id' => 4,
            'created_at' => '2019-08-07 00:00:00',
            'updated_at' => '2019-08-07 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '資本家マインドセット',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-11-02 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '続・怪談和尚の京都怪奇譚',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-11-10 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'キャラ絵で学ぶ！仏教図鑑',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-12-08 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '政治を選ぶ力',
            'record_id' => 4,
            'created_at' => '2019-12-09 00:00:00',
            'updated_at' => '2019-12-09 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '中国とアラブがわかる世界史',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2019-12-13 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '痛快！コンピュータ学',
            'record_id' => 4,
            'created_at' => '2019-12-14 00:00:00',
            'updated_at' => '2019-12-14 00:00:00',
        ]);
        ...
        DB::table('items')->insert([
            ...
            'updated_at' => '2020-07-06 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => 'みんな大好き陰謀論',
            'record_id' => 4,
            'created_at' => '2020-07-07 00:00:00',
            'updated_at' => '2020-07-07 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '奇跡の経済教室 戦略編',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            'text' => '私は真実が知りたい 夫が遺書で告発「森友」改ざんはなぜ？',
            'record_id' => 4,
            'created_at' => '2020-07-16 00:00:00',
            'updated_at' => '2020-07-16 00:00:00',
        ]);
        DB::table('items')->insert([
            'text' => '営繕かるかや怪異譚',
            'record_id' => 4,
        ...
        DB::table('items')->insert([
            'text' => 'ichiroさん一撃で英語が話せる方法を教えて下さい！',
            'record_id' => 4,
